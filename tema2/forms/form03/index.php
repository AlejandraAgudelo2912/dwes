    ...
    <?php
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
           ...
           print_r($_POST);
            ...
            //indico el boton pulsado
            if (isset($_POST['boton'])) {
                if ($_POST['boton'] == 'tipo1') {
                    echo "<p class='centrado'>Has pulsado el botón de Alta tipo1</p>";
                } elseif ($_POST['boton'] == 'tipo2') {
                    echo "<p class='centrado'>Has pulsado el botón de Alta tipo2</p>";
                }
            } else {
                echo "<p class='centrado'>No has pulsado ningún botón</p>";
            }
        }
    ?>
